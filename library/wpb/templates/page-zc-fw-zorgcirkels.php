                ...
                <div class="post-header">
                    ...
                    <table id="post-header-collumns" width="100%" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            ...
                            <td class="tp-zorgcirkels-4"><div class="post-header-title text-right"><?php echo $pageHeaderTitel; ?></div></td>
                        </tr>
                    </table>
                    -->
                    <table id="post-header-row" width="100%" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            <td class="tp-zorgcirkels-row" width="100%"><div class="post-header-title text-right"><?php echo $pageHeaderTitel; ?></div></td>
                        </tr>
                    </table>
                </div>
